...
output.images[0].save("generated_image_LMS.png")
img = Image.open("generated_image_LMS.png")
plt.imshow(img)
plt.title(f"Generated Image (LMS Scheduler) - {elapsed_time:.2f} seconds")
plt.show()

# Print the elapsed time
print(f"LMS scheduler took {elapsed_time:.2f} seconds.")
